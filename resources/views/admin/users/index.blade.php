...
<head>
    ...
    <!-- Bootstrap CSS pour les modales (on peut utiliser notre propre CSS, mais on garde Bootstrap pour simplifier) -->
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-card.admin { border-left-color: var(--danger); }
        .stat-card.agent { border-left-color: var(--accent); }
        .stat-card.citoyen { border-left-color: var(--info); }
        ...
        /* ===== MODALES BOOTSTRAP OVERRIDE (pour correspondre au thème) ===== */
        .modal-content {
            border-radius: 16px;
            border: none;
...
@php
    ...
    $stats = [
        ...
        'agent' => $users->where('role', 'agent')->count(),
...
<div class="main">
    ...
    <div class="top-bar">
        <div class="top-bar-left">
            <h1><i class="bi bi-people me-2" style="color: var(--primary);"></i>Gestion des utilisateurs</h1>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card agent">
            ...
            <div class="stat-value">{{ $stats['agent'] }}</div>
        </div>
        <div class="stat-card citoyen">
    ...
    <div class="filter-card">
        <form method="GET" action="{{ route('admin.users.index') }}" class="row g-3 align-items-end">
            ...
            <div class="col-md-5">
                ...
                <a href="{{ route('admin.users.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-counterclockwise"></i> Réinitialiser</a>
            </div>
        </form>
    </div>
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1rem;">
        <h5 class="fw-bold mb-0"><i class="bi bi-person-plus me-2" style="color:var(--primary);"></i>Liste des utilisateurs</h5>
...
<!-- MODALES ÉDITER ET SUPPRIMER (pour chaque utilisateur) -->
@foreach($users as $u)
        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('admin.users.update', $u->id) }}">
                ...
                <div class="modal-header bg-warning text-white">
                    <h5 class="modal-title"><i class="bi bi-pencil me-2"></i>Modifier {{ $u->name }}</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Téléphone</label>
                        <input type="text" name="contact" class="form-control" value="{{ $u->contact }}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Rôle</label>
                        <select name="role" class="form-select" required>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Nouveau mot de passe <span class="text-muted">(optionnel)</span></label>
